...
const LikeSection = props => {
  ...
  const totalLikes = numberOfLikes;  
  return (
    <div>
      <div
      ...
      >
        <div className='like-section-wrapper'  >
          <FontAwesomeIcon icon={faHeart} onClick={likePost} className={'not-liked'}/>
          <FontAwesomeIcon icon={solidHeart} onClick={likePost} className={'liked'}/>
        </div>
        <div className='like-section-wrapper'>
          <FontAwesomeIcon icon={faComment} />
        </div>
      </div>
    <p className='like-number'>{totalLikes} likes</p>
    </div>
  );
};
